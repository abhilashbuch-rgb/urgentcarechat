...
export const STRINGS = {
  en: {
    ...
    alert911AriaLabel: "Call 911 emergency services",
    alert911Note: "If you can't call, have someone drive you to the nearest emergency room.",
    alert988Title: "I want you to be safe.",
    alert988Cta: "Call 988",
    alert988AriaLabel: "Call the 988 Suicide and Crisis Lifeline",
    alert988TextCta: "Text 988",
    alert988TextAriaLabel: "Text the 988 Suicide and Crisis Lifeline",
    alert988Note: "Free, confidential, available 24/7. You can also chat at 988lifeline.org.",
  ...
  es: {
    ...
    alert911AriaLabel: "Llamar al 911, servicios de emergencia",
    alert911Note: "Si no puede llamar, pida que alguien lo lleve a la sala de emergencias más cercana.",
    alert988Title: "Quiero que esté a salvo.",
    alert988Cta: "Llamar al 988",
    alert988AriaLabel: "Llamar a la Línea de Crisis y Suicidio 988",
    alert988TextCta: "Enviar texto al 988",
    alert988TextAriaLabel: "Enviar un mensaje de texto a la Línea de Crisis y Suicidio 988",
    alert988Note: "Gratis, confidencial, disponible las 24 horas. También puede chatear en 988lifeline.org.",
