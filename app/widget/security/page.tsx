...
export const metadata = {
  title: `Triage widget security — ${PRODUCT_NAME}`,
  description:
    `What the embeddable triage widget collects, what it doesn't, its subprocessors, and where it stands on SOC 2 and HIPAA.`,
};
...
//
// ABOUT THE TRIAGE WIDGET SPECIFICALLY, NOT THE COMPLIANCE BINDER. This
// file used to live at /security and was linked from the Binder's own
// marketing pages despite describing a different product entirely (the
// embeddable patient-triage chat at /widget) — moved here, to its own
// URL, once that mismatch was found. The Binder's own security page is
// at /security.
  ...
  return (
    <div className="lp">
      ...
      <main className="lp-main">
        <div className="sec-callout" style={{ marginTop: 24 }}>
          This page is about the embeddable triage widget specifically.
          Looking for the compliance Binder&rsquo;s security page instead?{" "}
          <Link href="/security">It&rsquo;s here.</Link>
        </div>
