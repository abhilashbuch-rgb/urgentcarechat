...
// ============================================================
// Main Chat Component
// `embed` renders a chrome-less version for the /widget iframe: no site
// header, no doctor CTA banner, just the chat itself. `tenant` themes
// the header with a branded portal's name/logo/color (see
// app/t/[tenant]) and trims the footer to what's relevant inside
// someone else's branded experience — same chat, same data logic
// either way, just presentation.
// ============================================================
export default function TriageApp({
  ...
  // responses, which stay focused on the medical situation. Skipped
        ...
        <div className="footer-note">
          {contained ? (
            ...
            <>
              ...
              {" · "}
              <a href={`${ROOT_URL}/disclaimer`}>Disclaimer</a>
              {" · "}
